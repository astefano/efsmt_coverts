...
#abstract reach
absReachII = Or(And(in_0, C1, going_up), And(in_0, C2, is_down), And(far_0, C0, going_up), And(near_0, C1, going_up), And(near_0, C2, coming_down), And(near_0, C1, is_up), And(far_0, C0, going_up), And(in_0, C1, is_up), And(far_0, C0, is_up), And(near_0, C2, coming_down), And(near_0, C1, going_up), And(far_0, C3, coming_down), And(near_0, C2, is_down), And(far_0, C3, is_down), And(near_0, C1, is_up), And(in_0, C2, coming_down), And(in_0, C2, coming_down)) 

#Enabled guided by absReach
En = Or(And(And(in_0,C1,going_up, -x_0 + t2_0 >= 0, -z + c0 >= 0, g1 - y >= 0), And(in_0,C1,going_up, -x_0 + t2_0 >= 0, -z + c0 >= 0, -g2 + y >= 0, g1 - y >= 0)), And(in_0, C2, is_down, -x_0 + t2_0 >= 0), And(And(far_0,C0,going_up, g1 - y >= 0), And(far_0,C0,going_up, -g2 + y >= 0, g1 - y >= 0)), And(near_0,C1,going_up, -x_0 + t0_0 >= 0, -x_0 + t2_0 >= 0, -z + c0 >= 0, g1 - y >= 0, x_0 - t1_0 >= 0), And(And(near_0,C2,coming_down, -x_0 + t0_0 >= 0, g0 - y >= 0), And(near_0,C2,coming_down, -x_0 + t0_0 >= 0, -g2 + y >= 0, g0 - y >= 0)), And(near_0,C1,is_up, -x_0 + t0_0 >= 0, -x_0 + t2_0 >= 0, -z + c0 >= 0, x_0 - t1_0 >= 0), And(far_0, C0, going_up, g1 - y >= 0), And(in_0, C1, is_up, c1 - z == 0, -x_0 + t2_0 >= 0, -c1 + c0 >= 0), And(far_0, C0, is_up), And(near_0,C2,coming_down, -x_0 + t0_0 >= 0, -x_0 + t2_0 >= 0, g0 - y >= 0, x_0 - t1_0 >= 0), And(And(near_0,C1,going_up, -x_0 + t0_0 >= 0, -z + c0 >= 0, g1 - y >= 0), And(near_0,C1,going_up, -x_0 + t0_0 >= 0, -z + c0 >= 0, -g2 + y >= 0, g1 - y >= 0)), And(And(far_0,C3,coming_down, g0 - y >= 0, c2 - z >= 0), And(far_0,C3,coming_down, -g2 + y >= 0, g0 - y >= 0, c2 - z >= 0)), And(near_0,C2,is_down, -x_0 + t0_0 >= 0, -x_0 + t2_0 >= 0, x_0 - t1_0 >= 0), And(far_0, C3, is_down, c2 - z >= 0), And(near_0, C1, is_up, c1 - z == 0, -x_0 + t0_0 >= 0, -c1 + c0 >= 0), And(And(in_0,C2,coming_down, -x_0 + t2_0 >= 0, g0 - y >= 0), And(in_0,C2,coming_down, -x_0 + t2_0 >= 0, -g2 + y >= 0, g0 - y >= 0)), And(in_0, C2, coming_down, -x_0 + t2_0 >= 0, g0 - y >= 0))

DisN = Not(En)

NewCond = True
NotAt2Locs_all = And(NotAt2Locs_train_0hh, NotAt2Locs_controllerhh, NotAt2Locs_gatehh)
PosClks = And(hat_0 >= 0, t1_0 >= 0, t2_0 >= 0, hepst >= 0, het_0 >= 0, x_0 >= 0, t0_0 >= 0, hac >= 0, hrc >= 0, c2 >= 0, hlc >= 0, c1 >= 0, hec >= 0, c0 >= 0, z >= 0, y >= 0, g2 >= 0, g1 >= 0, hepsg >= 0, g0 >= 0, hlg >= 0, hrg >= 0)
...
hrcrg, hacat_0, hecet_0, hlclg, hepsg, hepst = Ints('hrcrg hacat_0 hecet_0 hlclg hepsg hepst')
PosHClks = And(hrcrg >= 0, hacat_0 >= 0, hecet_0 >= 0, hlclg >= 0, hepsg >= 0, hepst >= 0)
EqsS = And(And(And(hlc == hlg, hec == het_0), hac == hat_0), hrc == hrg)
Gih = And(citrain_0hh, cicontrollerhh, cigatehh, EqsS, AddInvs, PosHClks )
dead = And(Gih, DisN)
EqsC = And(hlg == hlclg, hrg == hrcrg, hrc == hrcrg, hepsg == hepsg, het_0 == hecet_0, hlc == hlclg, hat_0 == hacat_0, hec == hecet_0, hepst == hepst, hac == hacat_0)
Sep = True
...
safe = True
#Solving EF formula: 
EFformula = Exists([g2,c2,t1_0,g1,c1,t2_0,g0,c0,t0_0], And(Kp_all, t0_0>=5, t1_0 >=0, g2>=0, g1 >= 2, ForAll([far_0, near_0, in_0, C0, C1, C2, C3, is_up, coming_down, is_down, going_up, hac, hrc, y, hat_0, hlc, hepsg, hepst, hec, het_0, x_0, hlg, hrg, z, hrcrg, hacat_0, hecet_0, hlclg, hepsg, hepst], Implies(Gih, And(safe, En)))))
s = Solver() 
s.add(EFformula) 
print s.check() 
print s.model()
