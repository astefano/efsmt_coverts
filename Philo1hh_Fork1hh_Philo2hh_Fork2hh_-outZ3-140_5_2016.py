...
Gih = And(ciPhilo1hh, ciFork1hh, ciPhilo2hh, ciFork2hh, EqsS, absReachII, NewCond)
dead = And(Gih, DisN)
...
GihExt = And(ciPhilo1hh, ciFork1hh, ciPhilo2hh, ciFork2hh, EqsS, EqsC, Sep, absReachII, NewCond)
...
Params = And(beta1 >= 3, eta1 >= 0, gamma1 >= 0, alpha1 >= 0, eta2 >= 0, beta2 >= 0, gamma2 >= 0, alpha2 >= 0)
...
Gi = And(ciPhilo1hh, ciFork1hh, ciPhilo2hh, ciFork2hh, absReachII, NewCond, PosClks)
safe = t1 + t2 <= 60
#Solving EF formula: 
EFformula = Exists([beta1, eta1, gamma1, alpha1, eta2, alpha2, beta2, gamma2], And(Params, Kparams, ForAll([p11, p12, p13, p10, f10, f11, p21, p22, p23, p20, f20, f21, ts1, t1, ts2, t2, hendphio1, heatphio1, hreleasephio1, htakeleftphio1, htakefork1, hreleasefork1, hendphio2, hreleasephio2, htakeleftphio2, heatphio2, htakefork2, hreleasefork2, hreleasephio1releasefork1releasefork2, htakeleftphio2takefork2, heatphio2takefork1, htakeleftphio1takefork1, heatphio1takefork2, hendphio1endphio2, hreleasephio2releasefork2releasefork1], Implies(Gi, And(safe, En)))))
